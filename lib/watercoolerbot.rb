...
class WaterCoolerBot < SlackRubyBot::Bot
  ...
  match /^millenial$/ do |client, data, match|
    client.say(channel: data.channel, text: millenial_responses, gif: 'https://scontent.fsnc1-1.fna.fbcdn.net/hphotos-xpf1/l/t31.0-8/12967308_1068280473252357_6081231978689125756_o.jpg')
  end
